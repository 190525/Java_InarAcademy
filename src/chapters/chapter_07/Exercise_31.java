...
public class Exercise_31 {
    ...
    public static int[] mergeList(int[] list1, int[] list2){
        ...
        int i=0;
        int j=1;
        //The first index is initialized with 1 to avoid " Array Index Out Of Bounds Exception "error
        // when comparing the last element of the merged array with the new element to be added.
        //While printing the array, the 0 value in the first index is not visible because it is initialized from the 2nd index.
